...
import org.firstinspires.ftc.teamcode.therealslimshady.roadrunner.util.Encoder;
...
public class RiverWolvesLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public RiverWolvesLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        super(Arrays.asList(
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getCurrentPosition() * MULTI_X),
                encoderTicksToInches(perpendicularEncoder.getCurrentPosition() * MULTI_Y)
        );
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getCorrectedVelocity() * MULTI_X),
                encoderTicksToInches(perpendicularEncoder.getCorrectedVelocity() * MULTI_Y)
        );
    }
}
